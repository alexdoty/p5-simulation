...
from p5_simulation.utils import augment_vector, augment_matrix, pretty
...
def main():
    ...
    net = Network.from_connections(
        [
            ...
            [0, 1, EM, 31 + 2j],
            [1, 2, EM, 20 + 5j, 1_000 + 500j],
            [1, 3, EM, 12 + 3j, 1_000 + 500j],
